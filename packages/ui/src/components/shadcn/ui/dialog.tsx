...
/**
 * ==========================================
 * ASSEMBLY UX RULES FOR DIALOGS & MODALS
 * ==========================================
 * - Dismissal: Modals must be closable by clicking the × button, pressing Escape, or clicking the backdrop. Never trap a user.
 * - Stacked Modals: Modals must not open other modals. If additional confirmation is needed, use inline messaging or inline warnings.
 * - Dirty Form Dismissal Guard: If the Dialog contains a form, you MUST intercept close attempts and check `isDirty`. If dirty, show a confirmation dialog (DiscardChangesConfirmationDialog) before dismissing.
 * - Visual Prominence: Centered dialogs are preferred for short, highly focused tasks, confirmations, or quick configuration screens.
 */
