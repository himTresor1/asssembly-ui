...
Shows how client requests flow through the API Gateway to core services (Auth, REST, Realtime) which all connect to PostgreSQL.

<ComponentPreview name="mermaid-demo" />

### OAuth Authorization Flow

Illustrates the OAuth 2.0 authorization code flow, showing the handoff between a third-party app, your authorization endpoint, and the Auth Server for token exchange.
