...
/**
 * ==========================================
 * ASSEMBLY UX RULES FOR ALERT DIALOGS
 * ==========================================
 * - Destructive Confirmation Friction: Destructive actions (delete, remove, revoke) MUST require a confirmation step. Clearly state what will be destroyed and whether it is reversible.
 * - Focus Default: Destructive confirmation dialogs must default focus to the "Cancel" button, not the "Confirm/Action" button.
 * - Hierarchy: Destructive actions must never be the primary action on any screen. They must be visually de-emphasized.
 */
