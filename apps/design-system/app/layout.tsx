...
import { customFont, firaCode } from './fonts'
import { Providers } from './Providers'
import { Toaster } from './toaster'

const className = `${customFont.variable} ${firaCode.variable}`
...
export const metadata: Metadata = {
  applicationName: 'Assembly Design System',
  title: 'Assembly Design System',
  description: 'Design resources for building consistent user experiences at Assembly.',
      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `:root{--font-custom:${customFont.style.fontFamily};--font-source-code-pro:${firaCode.style.fontFamily};--font-fira-code:${firaCode.style.fontFamily};}`,
          }}
        />
      </head>
      <body>
