...
Use ErrorDisplay as the base for any inline error state in your application. For errors with known patterns, you can wire up an error matching utility on top to automatically inject matching troubleshooting steps.
