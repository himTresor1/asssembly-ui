---
title: Copywriting
description: A concise guide for writing UI copy in Assembly.
---
...
- **Assembly** (capitalize except in code)

## Formatting

- **Bold for emphasis** only when necessary
- **Inline code** for technical terms: `RLS`, `API key`, `assembly-ui init`
