...
/**
 * ==========================================
 * ASSEMBLY UX RULES FOR SHEETS & DRAWERS
 * ==========================================
 * - Sheet Choice: Use Sheets (sliding in from the right) for longer forms, configuration panels, detailed views, and data editors (cramped in centered dialogs).
 * - Layout Structure: Group content predictably with SheetHeader, SheetSection, and a sticky SheetFooter.
 * - Form Dismissal: When containing a form, always keep top-right close and backdrop click dismissals enabled. If form has unsaved changes (isDirty), show a discard confirmation alert dialog instead of closing silently.
 */
