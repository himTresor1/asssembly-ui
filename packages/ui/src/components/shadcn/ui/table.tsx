...
/**
 * ==========================================
 * ASSEMBLY UX RULES FOR TABLES
 * ==========================================
 * - Column Alignment: Text columns left-aligned, Numeric columns right-aligned, Status/Date right-aligned, Actions/Buttons right-aligned.
 * - Mobile Responsiveness: Tables with more than 5 columns must support horizontal scrolling on mobile. Never let table content overflow or truncate silently.
 * - Empty Cells: Empty cells must be marked explicitly (em dash —, "N/A", or "—"). Never leave a cell blank without meaning.
 * - Context Usage: Use presentational Table for simple static datasets under 15 rows. Composed DataTable (TanStack Table) is selected for sorting/filtering/pagination/row selection.
 */
