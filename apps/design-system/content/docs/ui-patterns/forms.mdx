---
title: Forms
description: Common form patterns used in application settings pages and side panels.
---

Forms in your applications should follow consistent patterns to ensure a cohesive user experience across settings pages and side panels. This guide covers the most common form patterns and field types.
...
The form previews above include both repeated-field patterns:
